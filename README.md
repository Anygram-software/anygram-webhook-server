...
```
когда вы не указали апи ключ в софте по умочанию он changethis123
Обязательно установите свой собственный в настройкай Anygram-клиента
...
или 
```
https://{IP}:4545/anygram_hooks (если ставили задали в настройках)
```
