...
Если порты открыты то можно вставлять эту ссылку в софт в Webhook URL.
...
Далее настройте в софте какие события вы хотите получать по вебхукам. 
Сервер из данного примера просто парсит и принтит данные каждого вебхука для примера, вы же можете использовать информацию из вебхуков в своих приложениях. 
